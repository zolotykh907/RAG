...
from app.indexing.data_processing import normalize_text, check_data_quality, compute_text_hash
from app.indexing.data_vectorize import load_embeddings, save_embeddings, create_embeddings
